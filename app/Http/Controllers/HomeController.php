...
class HomeController extends Controller
{
	...
	public function welcome()
	{
		...
		return view('computer.addBlade.welcome', array_merge($public_var, [
			'slides' => $slides,
			'hot_news' => $hot_news,
			'big_sale' => $big_sale,
	...
	public function index()
	{
		...
		return view('computer.home.index', array_merge($public_var, [
			'slides' => $slides,
			'hot_news' => $hot_news,
			'big_sale' => $big_sale,
			'products_sale_bottom' => $products_sale_bottom,
	...
	public function get_post_ajax(Request $request)
	{
		...
		return view('computer.home.content_ajax', [
			"detail_product" => $detail_product,
			"idproduct" => $idproduct,
